        ...
        columns: [
            {
                ...
                render: (value: unknown, row: Record<string, unknown>) => {
                    ...
                    const imageUrl = imageValue ? createImageUrl(imageValue) : '/food.svg';
                    return (
                        <div className="w-16 h-12 overflow-hidden rounded-lg flex-shrink-0">
                            <img
                                src={imageUrl}
                                alt={(row.name as string) || '商品画像'}
            ...
            },
            {
                ...
                filterable: true,
                width: 120,
                format: (value: unknown) => `¥${new Intl.NumberFormat('ja-JP').format(value as number)}`,
            },
            {
                key: 'category',
                label: 'カテゴリ',
            ...
            },
            {
                ...
                format: (value: unknown) => {
                    ...
                    return strValue ? strValue.substring(0, 50) + (strValue.length > 50 ? '...' : '') : '';
                },
            },
        ],
